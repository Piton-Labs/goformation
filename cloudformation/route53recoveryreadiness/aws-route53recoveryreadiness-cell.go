...
// Cell AWS CloudFormation Resource (AWS::Route53RecoveryReadiness::Cell)
...
func (r *Cell) AWSCloudFormationType() string {
	return "AWS::Route53RecoveryReadiness::Cell"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Cell) MarshalJSON() ([]byte, error) {
...
func (r *Cell) UnmarshalJSON(b []byte) error {
	type Properties Cell
	res := &struct {
		Type                string
		Properties          *Properties
