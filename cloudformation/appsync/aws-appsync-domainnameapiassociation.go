...
// DomainNameApiAssociation AWS CloudFormation Resource (AWS::AppSync::DomainNameApiAssociation)
...
func (r *DomainNameApiAssociation) AWSCloudFormationType() string {
	return "AWS::AppSync::DomainNameApiAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DomainNameApiAssociation) MarshalJSON() ([]byte, error) {
	type Properties DomainNameApiAssociation
...
func (r *DomainNameApiAssociation) UnmarshalJSON(b []byte) error {
	type Properties DomainNameApiAssociation
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = DomainNameApiAssociation(*res.Properties)
	}
