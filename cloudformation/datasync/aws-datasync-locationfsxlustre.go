...
// LocationFSxLustre AWS CloudFormation Resource (AWS::DataSync::LocationFSxLustre)
...
func (r *LocationFSxLustre) AWSCloudFormationType() string {
	return "AWS::DataSync::LocationFSxLustre"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LocationFSxLustre) MarshalJSON() ([]byte, error) {
	type Properties LocationFSxLustre
...
func (r *LocationFSxLustre) UnmarshalJSON(b []byte) error {
	type Properties LocationFSxLustre
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = LocationFSxLustre(*res.Properties)
	}
