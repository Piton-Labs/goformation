...
// WebACL_CaptchaConfig AWS CloudFormation Resource (AWS::WAFv2::WebACL.CaptchaConfig)
...
func (r *WebACL_CaptchaConfig) AWSCloudFormationType() string {
	return "AWS::WAFv2::WebACL.CaptchaConfig"
}
