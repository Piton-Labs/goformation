...
// HookTypeConfig AWS CloudFormation Resource (AWS::CloudFormation::HookTypeConfig)
...
func (r *HookTypeConfig) AWSCloudFormationType() string {
	return "AWS::CloudFormation::HookTypeConfig"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r HookTypeConfig) MarshalJSON() ([]byte, error) {
	type Properties HookTypeConfig
...
func (r *HookTypeConfig) UnmarshalJSON(b []byte) error {
	type Properties HookTypeConfig
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = HookTypeConfig(*res.Properties)
	}
