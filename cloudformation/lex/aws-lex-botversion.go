...
// BotVersion AWS CloudFormation Resource (AWS::Lex::BotVersion)
...
func (r *BotVersion) AWSCloudFormationType() string {
	return "AWS::Lex::BotVersion"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r BotVersion) MarshalJSON() ([]byte, error) {
	type Properties BotVersion
...
func (r *BotVersion) UnmarshalJSON(b []byte) error {
	type Properties BotVersion
	res := &struct {
		Type                string
		Properties          *Properties
